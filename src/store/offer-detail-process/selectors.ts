...
export const getAreOfferCommentsLoading = (state: State): boolean => state[NameSpace.OfferDetail].areOfferCommentsLoading;
...
export const getAreNearByLoading = (state: State): boolean => state[NameSpace.OfferDetail].areNearByLoading;
